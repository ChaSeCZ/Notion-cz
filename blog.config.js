...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '3a5df124fdf46bdb9675cd77291f530,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '茶色', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '秦始皇', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tawneycz.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '茶色, CZ', // 网站关键词 英文逗号隔开
